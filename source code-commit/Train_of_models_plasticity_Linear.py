...
sheet.cell(row=1, column=5).value = "真实塑性(%)"
sheet.cell(row=1, column=6).value = "预测塑性(%)"
...
# 保存为.xlsx文件
wb.save('F:/Ti、B有能量密度/prediction_Linear_11_train_plasticity.xlsx')
...
# 保存为.xlsx文件
wb.save('F:/Ti、B有能量密度/prediction_Linear_11_test_plasticity.xlsx')
