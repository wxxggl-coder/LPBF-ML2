...
# model = ExtraTreesRegressor(max_depth=5, min_samples_split=29, min_samples_leaf=0.026,
#                             min_weight_fraction_leaf=0.044, max_features=89, max_leaf_nodes=31,
#                             min_impurity_decrease=0.915)
...
# 保存为.xlsx文件
wb.save('F:/Ti、B有能量密度/prediction_extra_tree_11_train_strength.xlsx')
...
# 保存为.xlsx文件
wb.save('F:/Ti、B有能量密度/prediction_extra_tree_11_test_strength.xlsx')
