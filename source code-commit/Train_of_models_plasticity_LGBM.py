...
i_runs = 100
# model = LGBMRegressor(learning_rate=0.1, max_depth=10, max_features=21, min_child_samples=8,
#                       n_estimators=962, reg_alpha=1, reg_lambda=5)
# 更换模型
model = LGBMRegressor()
...
# 保存为.xlsx文件
wb.save('F:/Ti、B有能量密度/prediction_LGBM_11_train_plasticity.xlsx')
...
# 保存为.xlsx文件
wb.save('F:/Ti、B有能量密度/prediction_LGBM_11_test_plasticity.xlsx')